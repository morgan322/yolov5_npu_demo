/*******************************************************************************
* dhop_event_pushTrafficRetrograde.h
*
* Copyright (C) 2015-2030 ZheJiang Dahua Technology CO.,LTD.
*
* Description: 推送逆行车辆事件。
*
*******************************************************************************/

#ifndef __DHOP_EVENT_PUSHTRAFFICRETROGRADE_H__
#define __DHOP_EVENT_PUSHTRAFFICRETROGRADE_H__
...
/***************************************************************
* function name : DHOP_EVT_pushTrafficRetrograde
*
* description   : 推送逆行车辆事件
*
* input         : infos:  事件列表
...
***************************************************************/
DH_Int32 DHOP_EVT_pushTrafficRetrograde(const DHOP_EVT_TrafficRetrograde *infos, DH_Uint32 num);

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif // __DHOP_EVENT_PUSHTRAFFICRETROGRADE_H__
