/*******************************************************************************
* dhop_event_pushPackOpenDetection.h
*
* Copyright (C) 2015-2030 ZheJiang Dahua Technology CO.,LTD.
*
* Description: 包裹开箱验示检测事件。
*
*******************************************************************************/

#ifndef __DHOP_EVENT_PUSHPACKOPENDETECTION_H__
#define __DHOP_EVENT_PUSHPACKOPENDETECTION_H__
...
/***************************************************************
* function name : DHOP_EVT_pushPackOpenDetection
*
* description   : 包裹开箱验示检测事件
*
* input         : infos:  事件列表
...
***************************************************************/
DH_Int32 DHOP_EVT_pushPackOpenDetection(const DHOP_EVT_PackOpenDetection *infos, DH_Uint32 num);

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif // __DHOP_EVENT_PUSHPACKOPENDETECTION_H__
