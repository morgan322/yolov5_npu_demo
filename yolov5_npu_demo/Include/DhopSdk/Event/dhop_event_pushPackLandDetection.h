/*******************************************************************************
* dhop_event_pushPackLandDetection.h
*
* Copyright (C) 2015-2030 ZheJiang Dahua Technology CO.,LTD.
*
* Description: 推送包裹着地检测事件。
*
*******************************************************************************/

#ifndef __DHOP_EVENT_PUSHPACKLANDDETECTION_H__
#define __DHOP_EVENT_PUSHPACKLANDDETECTION_H__
...
#include "dhop_event_pushPackBrokenDetection.h"
/*******************************************************************************/
...
/***************************************************************
* function name : DHOP_EVT_pushPackLandDetection
*
* description   : 包裹着地检测事件
*
* input         : infos:  事件列表
*               : num:    事件个数
*
...
***************************************************************/
DH_Int32 DHOP_EVT_pushPackLandDetection(const DHOP_EVT_PackLandDetection *infos, DH_Uint32 num);

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif // __DHOP_EVENT_PUSHPACKLANDDETECTION_H__
